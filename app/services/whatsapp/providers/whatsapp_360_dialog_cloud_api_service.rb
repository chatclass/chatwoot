class Whatsapp::Providers::Whatsapp360DialogCloudApiService < Whatsapp::Providers::BaseService
  def send_message(phone_number, message)
    ...
    Rails.logger.info "Send message #{message.to_json}"
  ...
  def send_interactive_custom_message(phone_number, message)
    ...
    json_interactive = message.content    
    ...
    Rails.logger.info "send_interactive_custom_message Class Test #{json_interactive.gsub("=\u003e", ":")}" 
